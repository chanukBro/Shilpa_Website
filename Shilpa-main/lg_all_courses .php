...
<html>
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+Sinhala&family=Poppins:wght@500&display=swap" rel="stylesheet">
                        ...
                        <ul class="menu primary-menu header-search clearfix list-group list-unstyled">
                            ...
                            <li class="menu-link menu-open visible-desktop" role="presentation">
                                ...
                                <div class="nav-bar-group">
                                    <button aria-label="Courses menu" class="btn-icon btn-icon-primary btn-icon-md menu-btn h-100"
                                            type="button" id="menu-trigger-courses" aria-expanded="false">
                            ...
                            <li class="menu-link menu-open visible-desktop" role="presentation">
                                ...
                                <div class="nav-bar-group">
                                    <button aria-label="Programs &amp; Degrees menu"
                                            class="btn-icon btn-icon-primary btn-icon-md menu-btn h-100" type="button" id="menu-trigger-programs"
                                            aria-expanded="false">
                                        <span class="btn-icon__icon-container">
                                            <span class="pgn__icon btn-icon__icon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <footer>
            <div class="row primary">
                <div class="column about">
                    <h3>We Are Shilpa</h3>
                    <p>
                        Bringing you the best of virtual learning and empowering future minds. We are committed to make learning open
                        source, and free to anyone and everyone. Shilpa; Powering you to be the best version of Yourself.
                </div>
                <div class="column links">
                    <h3>Quick Links</h3>
                    <ul>
                        <li>
                            <a href="#faq">All Courses</a>
                        </li>
                        <li>
                            <a href="developers/developers.html">Developer Team</a>
                        </li>
                        <li>
